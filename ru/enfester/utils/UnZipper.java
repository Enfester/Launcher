...
public class UnZipper {
    ...
    public File recursiveUnzip(File inFile, File outFolder) {
        //Frame.getFramework().log("Extracting archive: " + inFile.getName() + " to " + outFolder.getName(), this.getClass());
        try {
            ...
            return outFolder;
              ...
              new MessegeWindow("UNZIP CLASS ERROR!", "Что то пошло не так."
                    + " Обратись к администратору с этой ошибкой.\n" + e.getMessage(), "Повторить");
            return inFile;
        }
    }
