...
public @interface SerializedName {
    ...
    /**
     * @return the desired names of the field when it is deserialized or
     * serialized. All of the specified names will be deserialized from. The
     * specified first name is what is used for serialization.
     */
    String value();
